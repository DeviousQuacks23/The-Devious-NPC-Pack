...
function toad.onTickEndNPC(v)
	...
	if data.state == 0 then
		...
		elseif data.animTimer < 23 then
            		v.animationFrame = 3
		elseif data.animTimer < 35 then
            		v.animationFrame = 2
		elseif data.animTimer < 47 then
            		v.animationFrame = 0
		elseif data.animTimer < 59 then
            		v.animationFrame = 2
		elseif data.animTimer < 71 then
            		v.animationFrame = 3
		elseif data.animTimer < 83 then
            		v.animationFrame = 2
		elseif data.animTimer < 95 then
            		v.animationFrame = 0
			data.state = 0
		end
        end
