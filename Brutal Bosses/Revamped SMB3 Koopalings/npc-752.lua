...
npcManager.setNpcSettings(iggyshellSettings)
...
--Register events
function iggyshell.onInitAPI()
	npcManager.registerEvent(npcID, iggyshell, "onTickNPC")
	--npcManager.registerEvent(npcID, iggyshell, "onTickEndNPC")
	--npcManager.registerEvent(npcID, iggyshell, "onDrawNPC")
	registerEvent(iggyshell, "onNPCHarm")
end

function iggyshell.onTickNPC(v)
	...
	if not data.initialized then
		...
		data.special = 0
		data.counter = iggySettings.counter --or 0
...
function iggyshell.onNPCHarm (eventObj, killedNPC, killReason, culprit)
