...
npcManager.setNpcSettings(mortonshellSettings)
...
--Register events
function mortonshell.onInitAPI()
	npcManager.registerEvent(npcID, mortonshell, "onTickNPC")
	--npcManager.registerEvent(npcID, mortonshell, "onTickEndNPC")
	--npcManager.registerEvent(npcID, mortonshell, "onDrawNPC")
	registerEvent(mortonshell, "onNPCHarm")
end

function mortonshell.onTickNPC(v)
	...
	if not data.initialized then
		...
		data.special = 0
		data.counter = mortonSettings.counter --or 0
		data.jumping = false
...
function mortonshell.onNPCHarm (eventObj, killedNPC, killReason, culprit)
